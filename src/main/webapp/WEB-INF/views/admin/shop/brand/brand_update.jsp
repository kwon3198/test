...
<!-- Content Wrapper. Contains page content -->
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-12">
							...
							<form id="form_brand" role = "form" action="/admin/shop/brand/update" method="post">
								<div class="form-group">
									<label>브랜드타입</label>
									<input value= "${brandVO.brand}" name="brand" type="text" class="form-control"
								...
								<div class="form-group">
									<label>브랜드출력순서</label>
									<input value= "${brandVO.brdsun}" name="brdsun" type="text" class="form-control"
					...
					<div class="card-body">
								...
								<a href = "#" id = "btn_delete" class="btn btn-danger">
									DELETE</a>
								<a href = "/admin/shop/brand/list" class="btn btn-info toastrDefaultInfo">
									LIST ALL</a>
					</div>
					<!-- /.content-wrapper -->
		...
		$(document).ready(function(){ //call back함수
			$("#btn_delete").click(function(){
				...
				$("#form_brand").attr("action","/admin/shop/brand/delete");
				$("#form_brand").submit();
				}
			});
		});
