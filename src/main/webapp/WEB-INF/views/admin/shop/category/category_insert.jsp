...
<!-- Content Wrapper. Contains page content -->
				...
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-12">
							...
							<form role = "form" action="/admin/shop/category/write" method="post">
								<div class="form-group">
									<label>카테고리</label>
									<input id ="category" value= "${categoryVO.category}" name="category" type="text" class="form-control"
										placeholder="게시판타입을 입력해 주세요" required>
								</div>
								...
								<div class="form-group">
									...
									<input value= "0" name="catesun" type="text" class="form-control"
		...
		$(document).ready(function(){
			...
			$("#category").blur(function(){
				var bod_type = $("#category").val();
				//Ajax => asyn비동기 Javascript And Xml(json사용-key:value)
				$.ajax({
					type:'get',
					url:'/admin/shop/catetype/catetype_check?category=' + category,
